...
\titleSlovene{Pridobivanje Strukturiranega Znanja skozi Pogovor ter s Pomočjo Množičenja}
%
...
\evaluationBoardMemberOne{Prof. Dr.\ Tomaž Erjavec}{Jožef Stefan Institute, Ljubljana, Slovenia}
%
% Evaluation board member #2 (title and name, affiliation)
\evaluationBoardMemberTwo{Prof.\ Iztok Savnik}{Univerza v Novi Gorici, Nova Gorica, Slovenia}
% 
% Date
