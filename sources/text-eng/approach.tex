...
\begin{gathered}
	...
	argClass(probableUserLocation,2, Place)
\end{gathered}
\end{equation}
\end{definition}
...
much as possible. While there is ifinite amount of things that can contribute
to contextual knowledge, the central and most important piecee in our 
approach is users location and the duration of stay at this location. 

To facilitate this
function, we use an improved implementation of the stay-point detection (Quannan, et al. 2008) algorithm, which is able to cluster raw GPS coordinates and detect when user is moving or staying at a particular location as shown in Fig. 5.
