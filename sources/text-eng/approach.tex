...
Now, to be able to say that things are 
instances of $Something$ ($is(x,Something)$, according to the constraint 
assertion above (\ref{as:is_arg2_domain}), $Something$ must be an instance of 
a $Class$. So we define it as so:
