...
KB can be named using a standard textual string. For this, we first need to
add a concept of $String$ on top of our \emph{upper ontology}.
...
Now we can also define the $name$ predicate, which is used to add concepts
a proper string representations.
