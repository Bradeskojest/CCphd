...
If we build on top of our usual example (\autoref{tab:conversation1}, after
clustering the coordinates and time, and filtering out the rest of the places,
the system creates a new concept  $JoesPizza$ and adds it into the KB:
\begin{equation}\label{joesPizza}
\begin{gathered}
	is(JoesPizza Place)
\end{gathered}
\end{equation}

After this, the \emph{Procedural Component} goes on and asserts additional
context assertions. To show that we need to define a new predicate.
