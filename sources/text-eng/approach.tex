...
$?PERSON$ can be replaced with instance or subclass of the concept $Person$. 
We start predicate names with a small letter ($predicate$) and the rest of the 
...
First we introduce the terms (concepts) that will allow us to construct the
upper ontology which is the glue of any knowledge base that can be used for 
machine inference:

\begin{equation}
Something, Class, Predicate, subclass, is, arity, argClass, argIs
\end{equation}
