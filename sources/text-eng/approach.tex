...
\autoref{chapter:implementation}) of the described approach,	 
...
In \autoref{fig:Architecture} these modules are represented with the boxes,
...
of possible answers at the question generation time. These can be then picked by
...
as exact. In \emph{Curious Cat} implementation 
(section \ref{section:locationServlet}), we handled this to
