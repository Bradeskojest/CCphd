...
\forall P \forall x_1...x_n (P(x_1...x_n) \implies is(P,Predicate))
\end{equation}
\end{definition}
...
constraint defined in Definition \autoref{constraint:predicate}. After this 
...
All assertions in CC KB are only valid, when the predicates used in the 
assertion have the same number of arguments as defined with their $arity$ 
assertions. the KB are only valid in statemen
\end{definition}
