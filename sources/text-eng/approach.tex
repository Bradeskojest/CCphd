...
also use rules, where predicate (i.e. $P$) letter is also treated as avariable. 
...
one of the quantifiers ($\forall$ or $\exists$). 
...
\begin{gathered}
	...
	ccWantsToAsk(x,userLocation(x,\$y)
\end{gathered}
\end{equation}
...
available concept of a visit $Visit1$ (see assertion \ref{as:joesPizzaVisit})
...
\end{enumerate}
This last step triggers the inference angine (rule \ref{})


To produce the \autoref{step:where} from \autoref{tab:conversation1},
