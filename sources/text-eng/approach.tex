...
through an example KA conversation depicted in tables \hl{ref1, ref2}.
...
\begin{tabular}{|c|l|l|}
	\hline
	\multirow{2}{*}{Step num.} & \multicolumn{2}{c|}{Interaction}\\\cline{2-3}
...
The resulting implementation (described at the end in \hl{ref}) of the described
approach, named Curious Cat has a
multi objective goal, KA is the primary goal, while having an intelligent 
...
\hl{At this point the Upper ontology is defined. Does this sub-chapter need 
some conclusions, or explanation?}
