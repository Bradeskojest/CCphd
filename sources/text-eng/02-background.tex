...
\emph{Verbosity}. Similarly as Q20 above, Verbosity is a spoken game for two persons. One player  (narrator), picks a secret word (concept) and is allowed to give hints about the word, and other player (guesser) must figure out the word (concept) behind the hints.
