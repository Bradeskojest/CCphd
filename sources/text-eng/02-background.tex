...
\begin{landscape}
	...
	\begin{tabular}{lclcccccc}
		...
		CyN (Daxtron Labs) & Cyc+AIML  & \parencite{Wilcox2011}  & Chatbot & /  & ChatScript  & /  & /  & /  \\
		\hline
	\end{tabular}
\end{table}
\end{landscape}
...
\emph{AIML(Artificial Intelligence Mark-up Language} is an XML based scripting language. 
...
\emph {ChatScript} is an NLP expert system consisting of textual patterns 
...
\emph {CyN} is an AIML interpreter implementation with additional functionality
