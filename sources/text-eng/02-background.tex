...
abilities. It is based on \emph{Cyc} knowledge and also uses \emph{CycL} as the 
main representation language. The system is best described using the concrete
example, taken from the original paper by A. Sharma and K. 
Forbus\parencite{Sharma2010}:
