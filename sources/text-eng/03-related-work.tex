...
approaches here are under \emph{context} category.

While the Geo/spatial mining, clustering and extraction works that relate to 
the approach taken for context acquisition in our /emph{Curious Cat} system are
not strictly
This category of acquisition does not directly fit into any of the categories
introcudec in
not strictly a knowledge acquisition in the sense of formal
knowledge
