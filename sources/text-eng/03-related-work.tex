...
incorporates it into the broader system which is able to map particular visits i
nto the exact places (points of interest - POIs) and then additionally able to 
...
$T_dt$ threshold, which is must be higher than $T_d$, and sets a tolerated
...
\begin{algorithm}[htb]
\caption{Staypoint Detection Algorithm 2}
\label{alg:spd2}
