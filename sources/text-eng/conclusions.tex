...
duration. 
While the questions are somehow similar to those asked by our Curious Cat system and they are also based on the current user location, it is not clear, whether the answers are used in some way for further Knowledge Acquisition or they are just stored in a database.
