...
The results of the experiment showed that the approach is feasible nad gives a 
good quality results as knowledge that is imediatelly useful, even if the users 
...
The context and proactivity increase engagement from 7.1 assertions/day to 
...
try to apply some ranking algoritms to improve the ordering of the questions 
...
Another direction is to analyse the free text questions and answers that users
give, especially throgh MMHHI (\autoref{section:mmhhi}), and mine the patterns,
...
existing one), which would make it easy to construct knowledgeable chatbots. 
